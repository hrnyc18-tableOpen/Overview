...
import SymbolPrivateDining from "./symbols/PrivateDining.jsx";
...
class DetailsWithPrivateDining extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      readDetails: false
            ...
            <div id="section">
              ...
              <div>
                ...
                <span id="privateDiningDetails">
                  {this.props.restaurant.private_dining_details}
                </span>
                <br />
                <br />
...
export default DetailsWithPrivateDining;
