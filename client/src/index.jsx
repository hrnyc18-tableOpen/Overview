      ...
      if (this.state.restaurant.private_dining) {
          ...
          <div>
            ...
            <div className="row">
              <div className="column">
                <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><title>icon/ic_private_dining</title><desc>Created with Sketch.</desc><defs></defs><g id="Symbols" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd"><g id="icon/ic_private_dining"><rect id="Rectangle-77" fill="#2D3339" x="5" y="19" width="4" height="2" rx="0.5"></rect><path d="M4,4 L4,11 C4,12.6568542 5.34314575,14 7,14 C8.65685425,14 10,12.6568542 10,11 L10,4 L4,4 Z" id="Rectangle-77" stroke="#2D3339" strokeWidth="2"></path><rect id="Rectangle-77" fill="#2D3339" x="6" y="14" width="2" height="6" rx="0.5"></rect><rect id="Rectangle-77" fill="#2D3339" x="15" y="19" width="4" height="2" rx="0.5"></rect><path d="M14.3418861,8.19246067 L19.3418861,6.525794 C19.6038578,6.43847012 19.8870178,6.58005011 19.9743416,6.84202177 C19.9913361,6.893005 20,6.9463946 20,7.00013565 L20,7.9460431 C20,8.1612583 19.862285,8.35232772 19.6581139,8.42038475 L14.6581139,10.0870514 C14.3961422,10.1743753 14.1129822,10.0327953 14.0256584,9.77082365 C14.0086639,9.71984041 14,9.66645081 14,9.61270976 L14,8.66680232 C14,8.45158711 14.137715,8.26051769 14.3418861,8.19246067 Z" id="Rectangle-77" fill="#2D3339"></path><path d="M4.34188612,8.19246067 L9.34188612,6.525794 C9.60385778,6.43847012 9.88701776,6.58005011 9.97434165,6.84202177 C9.99133606,6.893005 10,6.9463946 10,7.00013565 L10,7.9460431 C10,8.1612583 9.86228495,8.35232772 9.65811388,8.42038475 L4.65811388,10.0870514 C4.39614222,10.1743753 4.11298224,10.0327953 4.02565835,9.77082365 C4.00866394,9.71984041 4,9.66645081 4,9.61270976 L4,8.66680232 C4,8.45158711 4.13771505,8.26051769 4.34188612,8.19246067 Z" id="Rectangle-77" fill="#2D3339"></path><path d="M14,4 L14,11 C14,12.6568542 15.3431458,14 17,14 C18.6568542,14 20,12.6568542 20,11 L20,4 L14,4 Z" id="Rectangle-77" stroke="#2D3339" strokeWidth="2"></path><rect id="Rectangle-77" fill="#2D3339" x="16" y="14" width="2" height="6" rx="0.5"></rect></g></g></svg>
                ...
                <span>{this.state.restaurant.hours.map((hour) => {
                  return (
                    <span>{hour}</span>
                  )}
                )}</span><br></br>
                ...
                <span className="hyperlink">{this.state.restaurant.OverviewChildSchema.website}</span><br></br>
              ...
              <div className="column">
                ...
                <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><title>icon/ic_public_transit</title><desc>Created with Sketch.</desc><defs></defs><g id="Symbols" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd"><g id="icon/ic_public_transit"><g id="ic_public_transit"><rect id="boundry" x="0" y="0" width="24" height="24"></rect><g id="Group-71" transform="translate(4.000000, 2.000000)"><g id="Group-70"><path d="M3,2 C1.8954305,2 1,2.8954305 1,4 L1,16 C1,16.5522847 1.44771525,17 2,17 L14,17 C14.5522847,17 15,16.5522847 15,16 L15,4 C15,2.8954305 14.1045695,2 13,2 L3,2 Z" id="Rectangle-62" stroke="#333333" strokeWidth="2"></path><rect id="Rectangle-63" fill="#333333" x="3" y="0" width="10" height="3" rx="1.5"></rect><rect id="Rectangle-63" fill="#333333" x="1" y="9" width="14" height="2" rx="1"></rect><rect id="Rectangle-64" fill="#333333" x="3" y="16" width="3" height="4" rx="1"></rect><rect id="Rectangle-64" fill="#333333" x="3" y="12" width="3" height="3" rx="1.5"></rect><rect id="Rectangle-64" fill="#333333" x="10" y="16" width="3" height="4" rx="1"></rect><rect id="Rectangle-64" fill="#333333" x="10" y="12" width="3" height="3" rx="1.5"></rect></g></g></g></g></g></svg>
        ...
        return (
          <div className="container">
            ...
            <span> {this.state.restaurant.aggregate_score.toFixed(1)}</span>
            <icon id="reviewIcon"></icon>
            <span> {this.state.restaurant.OverviewChildSchema.review_count} </span>
            <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><title>icon/ic_price_range</title><desc>Created with Sketch.</desc><defs></defs><g id="Symbols" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd"><g id="icon/ic_price_range"><g id="ic_price_range"><rect id="boundry" x="0" y="0" width="24" height="24"></rect><rect id="outside" stroke="#333333" strokeWidth="2" x="3" y="6" width="18" height="12" rx="2"></rect><rect id="line" fill="#333333" x="3" y="6" width="3" height="3" rx="0.5"></rect><rect id="line" fill="#333333" x="18" y="6" width="3" height="3" rx="0.5"></rect><rect id="line" fill="#333333" x="3" y="15" width="3" height="3" rx="0.5"></rect><rect id="line" fill="#333333" x="10" y="10" width="4" height="4" rx="2"></rect><rect id="line" fill="#333333" x="18" y="15" width="3" height="3" rx="0.5"></rect></g></g></g></svg>
            <span> {this.state.restaurant.price_quantile} </span>
            <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1" ><title>icon/ic_cuisine</title><desc>Created with Sketch.</desc><defs></defs><g id="Symbols" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd"><g id="icon/ic_cuisine"><g id="ic_cuisine"><rect id="boundary" x="0" y="0" width="24" height="24"></rect><path d="M14.55,2 C14.2462434,2 14,2.24624339 14,2.55 L14,21 C14,21.5522847 14.4477153,22 15,22 L16,22 C16.5522847,22 17,21.5522847 17,21 L17,17 L18,17 C19.1045695,17 20,16.1045695 20,15 L20,7.45 C20,4.44004811 17.5599519,2 14.55,2 L14.55,2 Z M18,15 L16,15 L16,4.32 C17.2176535,4.88673047 17.9973291,6.10692278 18,7.45 L18,15 Z" id="Shape" fill="#333333" fillRule="nonzero"></path><path d="M11,2 L6,2 C4.8954305,2 4,2.8954305 4,4 L4,11 C4,12.1045695 4.8954305,13 6,13 L7,13 L7,21 C7,21.5522847 7.44771525,22 8,22 L9,22 C9.55228475,22 10,21.5522847 10,21 L10,13 L11,13 C12.1045695,13 13,12.1045695 13,11 L13,4 C13,2.8954305 12.1045695,2 11,2 Z M11,11 L6,11 L6,4 L7,4 L7,8.5 C7,8.77614237 7.22385763,9 7.5,9 C7.77614237,9 8,8.77614237 8,8.5 L8,4 L9,4 L9,8.5 C9,8.77614237 9.22385763,9 9.5,9 C9.77614237,9 10,8.77614237 10,8.5 L10,4 L11,4 L11,11 Z" id="Shape" fill="#333333" fillRule="nonzero"></path></g></g></g></svg>
            <span> {this.state.restaurant.cuisine[0]}</span>
            </div>
            <br></br>
            <div id="ulTag">
              ...
              {this.state.restaurant.tags.map((tag) => {
                return (
                  <li className="liTag"><div className="divTag"><a className="aTag">{tag}</a></div></li>
                )
              })}
            </div>
            <br></br>
            ...
            <div className="row">
              <div className="column1">
                      ...
                      <g fill="none" fillRule="evenodd">
                        <rect width="24" height="24"></rect>
                          <g transform="translate(3 2)">
                            <path stroke="#333333" strokeWidth="2" d="M7.32550582,4.0945285 C7.84035094,4.03146621 8.39760374,4 9,4 C9.60239626,4 10.1596491,4.03146621 10.6744942,4.0945285 C10.8844525,3.77431614 11,3.39700119 11,3 C11,1.8954305 10.1045695,1 9,1 C7.8954305,1 7,1.8954305 7,3 C7,3.39700119 7.1155475,3.77431614 7.32550582,4.0945285 Z"></path>
                            <path stroke="#333333" strokeWidth="2" d="M16.027822,12.0000146 C16.0556944,6.52731707 13.7899702,4 9,4 C4.21002973,4 1.94431329,6.52731623 1.9722357,12.0000005 L16.027822,12.0000146 Z"></path>
                            <path fill="#333333" d="M1.5,14 L16.5,14 L16.5,14 C16.7761424,14 17,14.2238576 17,14.5 L17,15 L17,15 C17,15.5522847 16.5522847,16 16,16 L2,16 L2,16 C1.44771525,16 1,15.5522847 1,15 L1,14.5 L1,14.5 C1,14.2238576 1.22385763,14 1.5,14 Z"></path>
                            <rect width="2" height="5" x="8" y="14" fill="#333333"></rect>
                            <rect width="6" height="2" x="6" y="18" fill="#333333" rx=".5"></rect>
                          </g>
                      </g>
                    </svg>
                  </div>
                  <div className="column3">
                    <span className="sectionName">Dining style</span><br></br>
                    <span className="sectionDescription">{this.state.restaurant.dining_style}</span><br></br>
                  </div>
                </div>
                <br></br>
                <div className="row">
                  ...
                  <div className="column3">
                    <span className="sectionName">Cuisines</span><br></br>
                    {this.state.restaurant.cuisine.map((food, index) => {
                      if (index === this.state.restaurant.cuisine.length - 1) {
                        return(
                ...
                <div className="row">
                  <div className="column2">
                    <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><title>icon/ic_clock</title><desc>Created with Sketch.</desc><defs></defs><g id="Symbols" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd"><g id="icon/ic_clock"><rect id="boundry" x="0" y="0" width="24" height="24"></rect><circle id="Oval" stroke="#333333" strokeWidth="2" cx="12" cy="12" r="8"></circle><rect id="Rectangle-3" fill="#333333" x="11" y="7" width="2" height="6" rx="0.5"></rect><rect id="Rectangle-3" fill="#333333" x="11" y="11" width="4" height="2" rx="0.5"></rect></g></g></svg>
                  </div>
                  <div className="column3">
                    <span className="sectionName">Hours of operation</span><br></br>
                    <span className="sectionDescription">{this.state.restaurant.hours.map((hour) => {
                      return (
                ...
                <div className="row">
                  ...
                  <div className="column3">
                    <span className="sectionName">Private party facilities</span><br></br>
                    <span className="sectionDescription">{this.state.restaurant.private_party_facilities}</span><br></br>
                  </div>
                </div>
                <br></br>
                <div className="row">
                  <div className="column2">
                    <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><title>icon/ic_contact</title><desc>Created with Sketch.</desc><defs></defs><g id="Symbols" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd"><g id="icon/ic_contact"><g id="ic_contact"><rect id="boundry" x="0" y="0" width="24" height="24"></rect><rect id="outside" stroke="#333333" strokeWidth="2" x="5" y="4" width="14" height="16" rx="2"></rect><rect id="line" fill="#333333" x="3" y="7" width="4" height="2" rx="0.5"></rect><rect id="line" fill="#333333" x="3" y="11" width="4" height="2" rx="0.5"></rect><rect id="line" fill="#333333" x="3" y="15" width="4" height="2" rx="0.5"></rect><rect id="line" fill="#333333" x="9" y="7" width="7" height="2" rx="0.5"></rect><rect id="line" fill="#333333" x="9" y="11" width="7" height="2" rx="0.5"></rect><rect id="line" fill="#333333" x="9" y="15" width="7" height="2" rx="0.5"></rect></g></g></g></svg>
                  </div>
                  <div className="column3">
                    <span className="sectionName">Private party contact</span><br></br>
                    <span className="sectionDescription">{this.state.restaurant.private_party_contact_name}</span><br></br>
                    <span className="sectionDescription">{this.state.restaurant.private_party_contact_number}</span><br></br>
                  </div>
                </div>
              </div>
              <div className="column1">
                <Map latitude={this.state.restaurant.OverviewChildSchema.coordinates.latitude} longitude={this.state.restaurant.OverviewChildSchema.coordinates.longitude}/>
                <br></br>
                <div className="row">
                  <div className="column2">
                    <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><title>icon/ic_location</title><desc>Created with Sketch.</desc><defs></defs><g id="Symbols" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd"><g id="icon/ic_location"><g id="ic_location"><rect id="boundary" x="0" y="0" width="24" height="24"></rect><path d="M12,9 C12.5522847,9 13,9.44771525 13,10 C13,10.5522847 12.5522847,11 12,11 C11.4477153,11 11,10.5522847 11,10 C11,9.44771525 11.4477153,9 12,9 L12,9 Z M12,7 C10.3431458,7 9,8.34314575 9,10 C9,11.6568542 10.3431458,13 12,13 C13.6568542,13 15,11.6568542 15,10 C15,8.34314575 13.6568542,7 12,7 Z" id="Shape" fill="#333333" fillRule="nonzero"></path><path d="M12,4 C15.3137085,4 18,6.6862915 18,10 C18,11.21 17.2,14 12,19.21 C6.8,14 6,11.21 6,10 C6,6.6862915 8.6862915,4 12,4 L12,4 Z M12,2 C7.581722,2 4,5.581722 4,10 C4,12.8133333 6.43333333,16.59 11.3,21.33 L11.3,21.33 C11.6888435,21.7111429 12.3111565,21.7111429 12.7,21.33 C17.5666667,16.59 20,12.8133333 20,10 C20,5.581722 16.418278,2 12,2 Z" id="Shape" fill="#333333" fillRule="nonzero"></path></g></g></g></svg>
                  </div>
                  <div className="column3">
                    <span className="hyperlink">{this.state.restaurant.OverviewChildSchema.display_address}</span><br></br>
                  </div>
                </div>
                <div className="row">
                  <div className="column2">
                  ...
                  <div className="column3">
                    <span className="sectionName">Neighborhood</span><br></br>
                    <span className="sectionDescription">{this.state.restaurant.neighborhood}</span><br></br>
                  </div>  
                </div>
                <br></br>
                <div className="row">
                ...
                <div className="row">
                  ...
                  <div className="column3">
                    <span className="sectionName">Public transit</span><br></br>
                    <span className="sectionDescription">{this.state.restaurant.public_transit}</span><br></br>
                  </div>
                </div>
                <br></br>
                <div className="row">
                  <div className="column2">
                    <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><title>icon/ic_entertainment</title><desc>Created with Sketch.</desc><defs></defs><g id="Symbols" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd"><g id="icon/ic_entertainment"><g id="ic_entertainment"><rect id="boundary" x="0" y="0" width="24" height="24"></rect><g id="Group-75" transform="translate(3.000000, 3.000000)"><rect id="Rectangle-61" stroke="#333333" strokeWidth="2" x="1" y="1" width="16" height="16" rx="2"></rect><circle id="Oval-8" fill="#333333" cx="7.5" cy="11.5" r="2.5"></circle><path d="M9.375,4 L10.3672178,4 L10.3672178,4 C10.6433602,4 10.8672178,4.22385763 10.8672178,4.5 C10.8672178,4.52073251 10.8659283,4.54144495 10.8633567,4.56201737 L9.98835672,11.5620174 L9.98835672,11.5620174 C9.95707992,11.8122318 9.74437942,12 9.49221778,12 L8.5,12 L8.5,12 C8.22385763,12 8,11.7761424 8,11.5 C8,11.4792675 8.00128951,11.458555 8.00386106,11.4379826 L8.87886106,4.43798263 L8.87886106,4.43798263 C8.91013786,4.18776822 9.12283837,4 9.375,4 Z" id="Rectangle-66" fill="#333333"></path><rect id="Rectangle-66" fill="#333333" x="9" y="4" width="4" height="2" rx="0.5"></rect></g></g></g></g></svg>
                  </div>
                  <div className="column3">
                    <span className="sectionName">Entertainment</span><br></br>
                    <span className="sectionDescription">{this.state.restaurant.entertainment}</span><br></br>
                  </div>
                </div>
                <br></br>
                <div className="row">
                  <div className="column2">
                    <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"><title>icon/ic_special_events</title><desc>Created with Sketch.</desc><defs></defs><g id="Symbols" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd"><g id="icon/ic_special_events"><g id="ic_special_events"><rect id="boundary" x="0" y="0" width="24" height="24"></rect><rect id="Rectangle-10-Copy" stroke="#333333" strokeWidth="2" x="4" y="6" width="16" height="14" rx="2"></rect><rect id="Rectangle-13-Copy" fill="#333333" x="3" y="9" width="18" height="2"></rect><rect id="Rectangle-13-Copy" fill="#333333" x="9" y="14" width="6" height="2" rx="0.5"></rect><rect id="Rectangle-13-Copy" fill="#333333" x="11" y="12" width="2" height="6" rx="0.5"></rect><rect id="Rectangle-6" fill="#333333" x="7" y="3" width="2" height="4" rx="1"></rect><rect id="Rectangle-6" fill="#333333" x="15" y="3" width="2" height="4" rx="1"></rect></g></g></g></svg>
                  </div>
                  <div className="column3">
                    <span className="sectionName">Special events and promotions</span><br></br>
                    <span className="sectionDescription">{this.state.restaurant.special_events_promotions}</span><br></br>
                  </div>
                </div>
                <br></br>
                <div className="row">
                  ...
                  <div className="column3">
                    <span className="sectionName">Additional</span><br></br>
                    <span className="sectionDescription">{this.state.restaurant.additional}</span><br></br>
                  </div>
                </div>
              </div>
            </div>
            <br></br>
            <div>
              <span id="privateDining">Private dining</span><br></br>
              <br></br>
              <span id="privateDiningDetails">{this.state.restaurant.private_dining_details}</span><br></br>
              <br></br>
              <a href='' id="privateDiningBtn1">
                <span id="privateDiningBtn2">View Private Dining Details</span>
              </a>
            </div>
            </div>
            {/* <div id="descriptionFade"></div> */}
          </div>
        )
      }
    } else {
